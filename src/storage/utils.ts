 ...
 */
export function getOptimizedKey(originalKey: string, suffix: OptimizedSuffix): string {
 ...
 */
export function getOptimizedUrl(originalUrl: string, suffix: OptimizedSuffix): string {
