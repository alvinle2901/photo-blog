  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="px-4 pt-8 md:px-6 lg:px-8">
        ...
        >
          {prevPhoto ? (
            <Link href={`${filmPath}/${prevPhoto.id}`} prefetch className="hover:text-gray-900 transition-colors">
              prev
            </Link>
          ) : (
          ...
          <Link href={filmPath} prefetch className="hover:text-gray-900 transition-colors">
            back to film
          </Link>

          {nextPhoto ? (
            <Link href={`${filmPath}/${nextPhoto.id}`} prefetch className="hover:text-gray-900 transition-colors">
              next
            </Link>
          ) : (
