...
export default function PhotoCard({
	...
	if (isPortrait) {
		return (
			...
			<div
				className="relative py-5 cursor-pointer group self-center mx-auto w-full max-w-[65vh]"
			...
			>
				...
				<div className="flex w-full cursor-pointer items-stretch gap-0 border border-[#d4c8a8] bg-[#faf6ef] p-2">
